        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl">
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="text-left">
                <p className="mono text-sm text-neutral-200 group-hover:text-[#25D366] transition-colors">
                  WhatsApp
                </p>
            ...
            <span className="mono text-sm text-neutral-600 group-hover:text-[#25D366] transition-colors">
              →
            </span>
          </a>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="text-left">
                <p className="mono text-sm text-neutral-200 group-hover:text-[#DC143C] transition-colors">
                  Email
                </p>
                <p className="text-xs text-neutral-500 mt-0.5">
                  Send me a message
